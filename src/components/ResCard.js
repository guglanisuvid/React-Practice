...
const ResCard = (props) => {
    ...
    return (
        <div className="flex flex-col w-60 h-full p-2 border-solid border-2 border-green-600 rounded-lg overflow-hidden text-lime-800 shadow-2xl hover:scale-[1.02] duration-200">
